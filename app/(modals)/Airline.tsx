...
import { FormulaOneTeam, formulaOneTeams } from "@/constants/BuyBusiness";
...
const HomeScreen = () => {
  ...
  const handleStartBusiness = (selectedPrice: FormulaOneTeam) => {
    navigation.navigate("(modals)/AirLineName", { selectedPrice });
  };
