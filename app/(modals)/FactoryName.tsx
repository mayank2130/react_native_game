...
import { FactoryPrice } from "@/constants/CreateBusiness";
...
const HomeScreen = () => {
  ...
  const routeParams = route.params as { selectedPrice?: FactoryPrice };
  const selectedPrice: FactoryPrice | undefined = routeParams?.selectedPrice;
