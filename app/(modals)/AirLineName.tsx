...
//   import { ShopPrice, shopPrice } from "@/constants/CreateBusiness";
  import { FormulaOneTeam } from "@/constants/BuyBusiness";
  ...
  const HomeScreen = () => {
    ...
    const routeParams = route.params as { selectedPrice?: FormulaOneTeam };
    const selectedPrice: FormulaOneTeam | undefined = routeParams?.selectedPrice;
