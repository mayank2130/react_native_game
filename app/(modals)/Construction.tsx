import {
  ...
  import {ConstructionPrice, constructionPrice } from "@/constants/CreateBusiness";
  ...
  const HomeScreen = () => {
    ...
    const handleStartBusiness = (selectedPrice: ConstructionPrice) => {
